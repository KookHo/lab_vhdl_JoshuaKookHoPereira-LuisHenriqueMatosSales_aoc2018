...
ARCHITECTURE structure OF Multiplexador4x1 IS
...
SIGNAL \G3|saida~0_combout\ : std_logic;
...
\G3|saida~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \G3|saida~0_combout\ = ( \S0~input_o\ & ( \S1~input_o\ & ( \A~input_o\ ) ) ) # ( !\S0~input_o\ & ( \S1~input_o\ & ( \B~input_o\ ) ) ) # ( \S0~input_o\ & ( !\S1~input_o\ & ( \C~input_o\ ) ) ) # ( !\S0~input_o\ & ( !\S1~input_o\ & ( \D~input_o\ ) ) )
